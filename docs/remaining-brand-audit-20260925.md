...
| ROSHN `cmt99f99p005gvsuclbx5elkf` | Identidade/PNG tecnicamente verificados; proprietário escolheu expressamente marca atual 2026/27 | Código, preflight novo, writer e confirmação pública antes de contar; decisão em `roshn-operational-decision.md` |

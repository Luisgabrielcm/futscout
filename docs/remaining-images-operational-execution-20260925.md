...
O diagnóstico seguinte, publicado no SHA `a1d78a80356e11b4d74586b4845b2d2ee02ba56d` e promovido no deployment `dpl_64cf1crRhnpSeitDXDmxvffTeAVp`, capturou somente metadados da resposta Production: SHA `797bac051d3e66cbc13c6d070762cc86c4301aa6ba830268b7251047f1f8326c`, PNG estruturalmente válido, 2693×301, 5 chunks e `originalChunkSetSha256` igual ao próprio SHA. Como esse hash difere do arquivo auditado (`875736…a8fac`), a resposta não é apenas uma diferença de metadata comprovada; os bytes de imagem permanecem diferentes. Não houve liberação nem cadastro dessa variante, e a A-League continua em fallback até existir captura visual segura ou uma fonte oficial estável com bytes auditáveis.

...
const messages = {
  ...
  goalkeeperEyebrow: ["GOLEIRO", "GOALKEEPER"],
  ...
  diving: ["Mergulho", "Diving"],
  handling: ["Jogo com as mãos", "Handling"],
  kicking: ["Chute", "Kicking"],
  gkPositioning: ["Posicionamento", "Positioning"],
  reflexes: ["Reflexos", "Reflexes"],
  goalkeeperAnalysisMissing: ["A análise específica ficará disponível quando os cinco atributos de goleiro estiverem persistidos.", "Goalkeeper analysis will be available when all five goalkeeper attributes are persisted."],
  goalkeeperStrengths: ["Destaques do perfil", "Profile highlights"],
  goalkeeperAttention: ["Menores notas do perfil", "Lowest profile ratings"],
